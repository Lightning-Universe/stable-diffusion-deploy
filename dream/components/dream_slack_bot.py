...
class DreamSlackCommandBot(SlackCommandBot):
    ...
    def handle_command(self):
        ...
        th.start()
        msg = f":zap: Generating image for prompt: _{prompt}_ :zap:. (This public version of the app may run slow. Get your own version of this app for faster performance)"  # noqa: E501
        return msg, 200
