...
class StableDiffusionServe(L.LightningWork):
    ...
    def predict(self, dream: str, num_images: int, image_size: int, num_inference_steps: int):
    ...
    def run(self):
        ...
        def predict_api(data: Data):
            ...
            try:
                ...
                result = pool.submit(
                    self.predict, data.dream, data.num_images, data.image_size, data.num_inference_steps
